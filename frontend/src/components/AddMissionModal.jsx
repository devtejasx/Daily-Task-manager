        ...
        >
          ...
          >
            ...
            <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="mt-3">
                    ...
                    <input
                      ...
                      className="holo-input mt-1.5 w-full bg-white/5 border border-white/10 rounded-xl px-3.5 py-2 text-sm text-amber-300 font-bold [color-scheme:dark]"
                    />
                    <p className="text-[9px] text-slate-500 mt-1 tracking-wider">
                      DEFAULT SCALES WITH HUNTER LEVEL ({defaultXP} XP)
                    </p>
                  </div>
                </div>
              ...
              <motion.button
                type="submit"
                className="relative w-full mt-2 font-display font-bold tracking-[0.25em] text-sm py-3 rounded-xl text-white overflow-hidden
